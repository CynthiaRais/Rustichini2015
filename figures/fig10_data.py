...
# specific offers for Figures 4C, 4G, 4K
x_offers = ((1, 0), (20, 1), (16, 1), (12, 1), (8, 1), (4, 1),
...
def compute_fig10_data(model_class=Model, network='symmetric'):
    ...
    model = model_class(n=n, ΔA=ΔA, ΔB=ΔB, random_seed=1,
                        r_o=6, w_p=1.65, δ_J_stim=δ_J_stim,
...
if __name__ == '__main__':
    def aux(args):
        compute_fig10_data(model_class=args['model_class'],
